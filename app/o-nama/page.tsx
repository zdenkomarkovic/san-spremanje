...
export default function ONama() {
  return (<div className=" pb-12">
    ...
    <div className="container mx-auto px-4 pt-24">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-primary text-center mb-14 mt-6">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-12 items-center">
          ...
          <div className="space-y-6">
            ...
            <div>
              <h4 className="text-xl font-semibold text-primary mb-3"> Naša Misija</h4>
              <p className="text-lg leading-relaxed">
            ...
            <div>
              <h4 className="text-xl font-semibold text-primary mb-3">Naša Vizija</h4>
              <p className="text-lg leading-relaxed">
...
<div className="flex flex-col md:flex-row md:gap-8 my-12 mx-auto justify-center">
